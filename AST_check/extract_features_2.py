    ...
    def visit_Call(self, node):
        ...
        if isinstance(node.func, ast.Attribute):
            ...
            # subprocess.Popen
                ...
                attr == "Popen" and isinstance(val, ast.Name) and val.id == "subprocess"
            ):
            ...
            if attr in ("get", "post", "urlopen"):
                ...
                elif isinstance(val, ast.Attribute) and getattr(val, "attr", "") in (
                    "request",
                ):
                    self.features["use_http_request"] += 1
            ...
            if (
                isinstance(val, ast.Name) and val.id == "zlib"
            ) and attr == "decompress":
